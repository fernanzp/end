...
<div id="voluntario-modal" class="modal fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
    ...
    <div>
        ...
        <input type="date" id="birthdate" name="birthdate" class="w-full bg-customLightGray text-customBeige font-bold rounded-lg p-4 border border-transparent focus:border-customGreen focus:ring-0 focus:outline-none" required>
    ...
    <div>
        ...
        <select id="gender" name="gender" class="w-full bg-customLightGray text-customBeige font-bold rounded-lg p-4">
    ...
    <div>
        ...
        <input type="tel" id="phone" name="phone" class="w-full bg-customLightGray text-customBeige font-bold rounded-lg p-4 placeholder:text-customBeige border border-transparent focus:border-customGreen focus:ring-0 focus:outline-none" pattern="[0-9]{10}" placeholder="Ej: 3141557864" required>
    </div>

    <!-- Nivel de educación -->
    <div>
        <label for="education" class="block text-customGreen font-bold text-xl mb-1">Nivel de educación:</label>
        <select id="education" name="education" class="w-full bg-customLightGray text-customBeige font-bold rounded-lg p-4" required>
    ...
    <div>
        ...
        <input type="text" id="address" name="address" class="w-full bg-customLightGray text-customBeige font-bold rounded-lg p-4 placeholder:text-customBeige border border-transparent focus:border-customGreen focus:ring-0 focus:outline-none" placeholder="Ingrese su dirección" required>
    </div>

    <!-- Cargar INE/DNI -->
    <div class="w-full">
        <p class="block text-customGreen font-bold text-xl mb-1">INE/DNI:</p>
        <input type="file" name="ine_document" id="ine_document" accept="image/*" class="hidden" onchange="updateFileName()"required>
