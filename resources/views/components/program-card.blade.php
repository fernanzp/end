<a href="{{ route('programview', ['id' => $program->id]) }}" class="bg-customLighterGray shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:scale-105 group">
    ...
    <div class="p-4">
        <h3 class="merriweather-bold font-bold text-xl mb-2 text-customGreen">{{ $program->title }}</h3>
        ...
        <p class="merriweather-bold text-lg font-bold text-customGreen">¡Quiero participar!</p>
