    ...
    <div class="relative h-screen w-full">
        ...
        <nav class="absolute top-0 w-full z-10">
            <ul class="flex justify-center space-x-8 p-4 bg-transparent text-customBeige">
                <li class="list-none">
                    <a href="{{ url('/') }}"
                        class="relative text-customBeige text-xl transition duration-300 ease-[cubic-bezier(0.25,0.8,0.25,1)] hover:font-bold">
                        Inicio
                    </a>
                </li>
                <li class="list-none">
                ...
                <li class="list-none relative">
                    ...
                    <div id="perfilContent"
                        class="hidden absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg transform translate-x-4">
...
<!-- Modal -->
<div id="paymentModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center"
    onclick="closeModalOnOutsideClick(event)">
    <div class="bg-white p-8 rounded-lg max-w-md w-full z-50 overflow-y-auto max-h-screen"
        onclick="event.stopPropagation()">
        <h2 class="text-xl font-bold mb-4">Proceder con el pago</h2>
        {{-- dice cuanto es lo que pagara el usuario --}}
        <p id="donation-amount" class="text-lg font-semibold text-customGreen mb-4"></p>

        <!-- Métodos de pago -->
        <div class="mb-4">
            <div id="paypal-button-container"></div> <!-- Contenedor de PayPal -->
        </div>
        <button onclick="closeModal()"
            class="mt-4 px-6 py-4 bg-red-600 text-white font-bold rounded hover:bg-red-800 w-full">
            Cancelar
        </button>
    </div>
</div>