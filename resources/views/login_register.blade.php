    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden" id="container_loginregister">
        ...
        <div class="absolute flex items-center justify-center flex-col w-1/2 h-full right-0 transition-transform duration-500" id="register">
            ...
            <form method="" action="" class="w-[70%]">
                ...
                <!--Apellidos-->
                <div class="relative my-10 w-full border border-customBeige rounded-md h-14 overflow-hidden focus-within:border-customGreen">
                    <input id="lastname" type="text" name="lastname" required class="peer w-full h-full px-4 pt-5 bg-transparent text-customBeige text-[18px] font-bold border-none outline-none placeholder-transparent">
                ...
                <div class="relative my-10 w-full border border-customBeige rounded-md h-14 overflow-hidden focus-within:border-customGreen">
                    <input id="confirm_password" type="password" name="confirm_password" required class="peer w-full h-full px-4 pt-5 bg-transparent text-customBeige text-[18px] font-bold border-none outline-none placeholder-transparent">
