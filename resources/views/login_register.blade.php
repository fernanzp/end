...
<body>
    ...
    <script>
        ...
        document.getElementById('terms-link').addEventListener('click', function(e) {
            ...
            openModal('Términos y Condiciones de la Plataforma END', `
            <p>
            1. Introducción: <br><br> Bienvenido a la plataforma de la ONG. Estos Términos y Condiciones rigen el uso de esta plataforma y de los servicios ofrecidos. Al registrarse y utilizar esta plataforma, el usuario acepta cumplir con estos términos y condiciones. Si no está de acuerdo, se le solicita que no utilice la plataforma.
            </p>
            <br><br> <p>2. Descripción de los Servicios: <br><br> La plataforma permite a los usuarios participar en los programas de la ONG, gestionar sus donaciones, ofrecerse como voluntarios, y obtener información sobre las actividades de la organización. La ONG se reserva el derecho de modificar o descontinuar los servicios en cualquier momento sin previo aviso.</p>
            <br><br> <p>3. Elegibilidad:  <br><br>Para registrarse en la plataforma, los usuarios deben tener al menos 18 años. Los menores de edad pueden registrarse únicamente con la aprobación y supervisión de un tutor legal, quien proporcionará la información necesaria y se responsabilizará por el uso de la plataforma por parte del menor.</p>
             <br><br><p>4. Registro y Cuenta del Usuario: <br><br>
            ...
            <br><br> <p>5. Uso Permitido: <br><br> El usuario acepta utilizar la plataforma únicamente para los fines permitidos por estos términos, las políticas de la ONG y la legislación aplicable. Está prohibido:
            ...
            <br><br> <p>
                6. Donaciones y Transacciones:  <br><br>La plataforma permite realizar donaciones para apoyar los programas de la ONG. Al hacer una donación, el usuario acepta que:
             ...
             <br><br><p>7. Participación en Programas de Voluntariado:  <br><br>Los usuarios que se inscriban como voluntarios deben cumplir con las políticas de conducta y los requisitos específicos de cada programa. La ONG se reserva el derecho de rechazar o cancelar la participación de cualquier usuario que no cumpla con estas políticas.
            </p>
             <br><br><p>8. Privacidad y Protección de Datos La ONG:  <br><br>Se compromete a proteger los datos personales de los usuarios conforme a la Política de Privacidad, que es parte de estos términos. Al registrarse en la plataforma, el usuario acepta el tratamiento de sus datos según lo dispuesto en dicha política.</p>
             <br><br><p>9. Propiedad Intelectual:  <br><br>Todo el contenido de la plataforma, incluidos textos, gráficos, logotipos, imágenes y software, es propiedad de la ONG o de sus licenciantes, y está protegido por las leyes de propiedad intelectual. Se prohíbe el uso, reproducción o distribución no autorizada de cualquier contenido de la plataforma.</p>
            <br><br> <p>10. Limitación de Responsabilidad La ONG no será responsable de: <br><br>
             ...
             <br><br><p>11. Modificaciones de los Términos y Condiciones La ONG:  <br><br>Se reserva el derecho de modificar estos Términos y Condiciones en cualquier momento. Las modificaciones serán efectivas desde su publicación en la plataforma. Se recomienda a los usuarios revisar los términos regularmente.</p>
             <br><br><p>12. Terminación del Acceso La ONG: <br><br>Se reserva el derecho de suspender o cancelar el acceso del usuario a la plataforma si considera que ha violado estos Términos y Condiciones o cualquier otra política de la organización.</p>
             <br><br><p>
                13. Ley Aplicable y Jurisdicción Estos Términos y Condiciones: <br><br>Se rigen por las leyes del país en el que está registrada la ONG. Cualquier disputa que surja en relación con estos términos será resuelta en los tribunales competentes de dicho país.</p>
             <br><br><p>14. Contacto: <br><br> Si tienes alguna pregunta sobre estos Términos y Condiciones, puedes ponerte en contacto con nosotros a través de:
        ...
        document.getElementById('privacy-link').addEventListener('click', function(e) {
            e.preventDefault(); // Prevenir el comportamiento predeterminado
            openModal('Política de Privacidad de la Plataforma END', `
            <p>1. Introducción:<br><br>

                        Esta Política de Privacidad describe cómo nuestra organización recopila, utiliza y protege la información personal de los usuarios de nuestra plataforma. Nos comprometemos a respetar y proteger la privacidad de nuestros usuarios de acuerdo con las leyes y regulaciones aplicables.</p><br><br>
                    <p>
                        2. Información que Recopilamos:<br><br>
                        ...
                        Datos de Navegación: dirección IP, tipo de navegador, tiempo de acceso y páginas visitadas para análisis de uso de la plataforma.</p><br><br>
                    <p>3. Uso de la Información:<br><br>
                        ...
                        Cumplimiento Legal: cumplir con las leyes y regulaciones aplicables, así como proteger nuestros derechos legales y los de nuestros usuarios.</p><br><br>
                    <p>4. Compartición de la Información:<br><br>
                        ...
                        Con Consentimiento del Usuario: cuando los usuarios nos otorguen permiso explícito para compartir su información.</p><br><br>
                    <p>5. Retención de la Información:<br><br>
                   ...
                   <br><br> <p>6. Derechos de los Usuarios:<br><br>
                   ...
                   <br><br> <p>7. Seguridad de la Información:<br><br>
                   ...
                   <br><br> <p>8. Privacidad de los Menores de Edad:<br><br>
                   ...
                   <br><br> <p>9. Cambios en la Política de Privacidad:<br><br>
                   ...
                   <br><br> <p>
                    ...
                    <br><br> <p>11. Aceptación de la Política de Privacidad:<br><br> Al utilizar la plataforma, el usuario reconoce haber leído y comprendido esta Política de Privacidad y acepta la recopilación, uso y almacenamiento de su información personal conforme a los términos aquí expuestos.</p>
            `);
        });
