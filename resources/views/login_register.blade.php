    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden" id="container_loginregister">
        ...
        <div class="absolute flex items-center justify-center flex-col w-1/2 h-full left-0 transition-transform duration-500 " id="login">
            ...
            <form method="POST" action="{{ route('login') }}" class="w-[70%]">
                ...
                <div class="google">
                    <a href="./google-auth/redirect" class="flex items-center justify-center w-full h-14 bg-[#4285F4] text-white font-bold text-[18px] rounded-[32px] border-none cursor-pointer transition-colors duration-300 hover:bg-[#357AE8] hover:text-[#F1F1F1]">
                        <img src="{{ asset('img/google.png') }}" class="h-8 mr-2">
